...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    switch (indexPath.row) {
        ...
        case 1: {
            ...
            NSString *date = [BTDateFormatter dateStringFromDate:post.createdAt];
            NSString *time = [BTDateFormatter timeStringFromDate:post.createdAt];
            
            UILabel *dateLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0)];
            dateLabel.text = date;
            dateLabel.font = [UIFont systemFontOfSize:12];
            dateLabel.textColor = [BTColor BT_navy:1];
            [dateLabel sizeToFit];
            ...
            titleLabel.textColor = [BTColor BT_navy:1];
            [titleLabel sizeToFit];
            ...
            messageLabel.textColor = [BTColor BT_navy:1];
            if (self.auth) {
                ...
                if ([self.post.attendance stateInt:self.user.id] == 0
                    ...
                    messageLabel.textColor = [BTColor BT_cyan:1];
                }
            }
        ...
        case 3: {
            ...
            image2.backgroundColor = [BTColor BT_navy:1];
        ...
        case 5: {
            if (self.auth) {
                ...
                attd.textColor = [BTColor BT_cyan:1];
                [attd sizeToFit];
                ...
                std.textColor = [BTColor BT_navy:1];
                [std sizeToFit];
                ...
                percent.textColor = [BTColor BT_navy:1];
                [percent sizeToFit];
