...
- (void)startTimerAsAttendance {
    NSInteger left = MAX(MIN(60, (ceil)(65.0f + [[self.post createdDate] timeIntervalSinceNow])), 0);
...
- (void)startTimerAsClicker {
    NSInteger left = MAX(MIN(self.post.clicker.progress_time, (ceil)(self.post.clicker.progress_time + 5 + [[self.post createdDate] timeIntervalSinceNow])), 0);
